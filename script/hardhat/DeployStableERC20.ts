...
async function main() {
  ...
  const USDC = await deploy<StableERC20>("StableERC20", undefined, "Selora Finance USD", "SFUSD", MINT_VALUE);
  const USDT = await deploy<StableERC20>("StableERC20", undefined, "Selora Finance USD+", "SFUSD+", MINT_VALUE);
